...
def insert_data(tables_dict):
    instance_connection_name = 'plasma-minutia-419203:us-central1:db-inteia'
    db_user = 'mysql'
    db_pass = 'belmont'
    db_name = 'inteia-db'
    ...
    conn = connector.connect(instance_connection_name, 'pymysql', user=db_user, password=db_pass, db=db_name)
...
if __name__ == "__main__":
    insert_data({'autores':df_autores, 'editoriales':df_editoriales, 'libros':df_libros})